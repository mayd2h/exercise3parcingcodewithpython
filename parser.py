import re
from main import Condition, ConditionalBlock, Block, FunctionBlock, Node, GlobalBlock
...
def main():
    ...
    with open(sample) as file:
        ...
        for eachline in lines:
            ...
            no_of_tabs = tabs
            print("", " ".join(map(lambda x: "'{0}'".format(x), condition_stack if len(condition_stack) > 0 else ["outofblock"])), end=" ")
